...
public class mokitController {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        mokkiColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("mokkinimi"));
        katuosoiteColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("katuosoite"));
        toimintaalueColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("toimintaalue"));
        kuvausColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("kuvaus"));


        palveluColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("palvelunimi"));
        toimintaaluePColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("alue"));
        hintaColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, Integer>("hinta"));
        kuvausPColumn.setCellValueFactory(new PropertyValueFactory<Mokitjapalvelut, String>("kuvauspalvelu"));
